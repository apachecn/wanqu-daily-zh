...
> 原文:[https://pspdfkit.com/blog/2017/webassembly-a-new-hope/?UTM _ source = Wanqu . co&UTM _ campaign = Wanqu+Daily&UTM _ medium = website](https://pspdfkit.com/blog/2017/webassembly-a-new-hope/?utm_source=wanqu.co&utm_campaign=Wanqu+Daily&utm_medium=website)
...
[![](../Images/23294a059e298dabec4ef3355385da24.png "Everything compiles into LLVM bitcode; The web is everywhere, and runs JavaScript; Compiling LLVM bitcode to JavaScript lets us run ~ everything, everywhere")](http://llvm.org/devmtg/2013-11/slides/Zakai-Emscripten.pdf) 
...
![](../Images/812ce06efe6671ce79ea8dfc65861844.png "asm.js pipeline: C/C++ will be compiled to LLVM IR via a compiler like clang. After that, Emscripten will pick up the intermediate representation and compile it to asm.js.")
...
![](../Images/87f0ac5ce2962729227ef2567a019b1b.png "Chrome, Firefox, Opera, and Edge* started to support WebAssembly in March 2017, and Safari is following this fall (*Edge support is guarded behind a feature flag).")
...
![](../Images/b797a3a5191b37e66348c5b86fb95b6f.png "WebAssembly vs. asm.js vs. native on mobile and desktop devices.")
