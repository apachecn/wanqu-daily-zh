...
> 原文:[https://segment.com/blog/show-hn-to-series-d/?UTM _ source = Wanqu . co&UTM _ campaign = Wanqu+Daily&UTM _ medium = website](https://segment.com/blog/show-hn-to-series-d/?utm_source=wanqu.co&utm_campaign=Wanqu+Daily&utm_medium=website)

每隔六个月，你就会在黑客新闻上看到这样一个帖子:

![Zoom with margin](../Images/fc07e68ef943b1fe3b38a2531f004514.png "asset_BYIX2oCpJodOE3In.png")
...
![Zoom with margin](../Images/1d9cb7be0596657937dc151a56e4813b.png "asset_3cjw3dlDGeBqiDQl.png")
...
![Zoom with margin](../Images/b793b892dcf00923598ac0e9c5f2f58b.png "asset_YKryG9mijJZXLqPe.png")
...
![Zoom with margin](../Images/978eab5b25ebfaf5a1e5104a385982cc.png "asset_MjHS63vRtsjzB3MB.png")
...
![Zoom with margin](../Images/c466af280d22bf44f0fea0f88599d86d.png "asset_k508Q4XzVjZzaE8t.png")
...
![Zoom with margin](../Images/6219389cdc440fc9882a69df05d6b268.png "asset_oy4OMjVDBQkF2AlQ.png")

寒假是我们的 API 第一次有稳定的流量。我们看到每秒钟都有几十个请求进来。

这与我们今天看到的成千上万的请求相去甚远，但至少是一个开始:

![Zoom with margin](../Images/2464c244441849571a2a00dea3e35cff.png "asset_AAo9RUi4Uu97Hzzx.png")
...
![Zoom with margin](../Images/6015ff62ed0f9398ccaae99170c9cadf.png "asset_bXIEsQySFSDxVlvs.png")
...
![Zoom with margin](../Images/54715090063c6b3c55775fc6c6f991df.png "asset_qeBW9gRozEUYWjAO.png")
...
![Zoom with margin](../Images/9aae03548559e42dfc5dc1768c2fd9c0.png "asset_osBvkQLbzoVOZFiN.png")
...
![Zoom with margin](../Images/d3076c8d44324407fb61054164f2469d.png "asset_CuRH8eMcDj302H8N.png")

前提很简单。每周，我们都会发布一个新的课程，承诺带你从零到分析专家。我们希望这是一个传播我们过去一年在分析生态系统中获得的所有知识的好方法。

![Zoom with margin](../Images/ceb2cf39bdc7256555dab088589be4fe.png "asset_mY2rIjVO3XI6Rkoe.png")
...
![Zoom with margin](../Images/a8f7914c393b02171f9ffb204e78001b.png "asset_SNjeLYKO2hNWQh2G.png")
...
![Zoom with margin](../Images/4cb9418f11deac4f3d0805eae25b8dc2.png "asset_obzHEImXdePm9FYU.png")![Zoom with margin](../Images/8d98b6838e0e9ef366bf087256a4a132.png "asset_AGk7JhRE7J2BHgSE.png")
...
![Zoom with margin](../Images/c98163f8941ee2bbcb25bf39d6013623.png "asset_IzZbAhD95CvqGKPE.png")![Zoom with margin](../Images/eeeab73899c3b1549b07fb515e92b39f.png "asset_cS3c6tDdO0zOIzd0.png")
...
![Zoom with margin](../Images/54ad140d1f8482c044fe0993b7be4470.png "asset_XV7P3COzLn0ryYLK.png")![Zoom with margin](../Images/49dacf6ad8209da530a8f14f0e39d22a.png "asset_717B3gOpnw6vNi4l.png")
...
![Zoom with margin](../Images/de76adddfda07b67461f044fe0aa21e6.png "asset_kapvbvZ7lzhvtB1y.png")

今天变化最大的是我们的盈利方式。当时，我们认为与合作伙伴分享收入可能是一个好主意，但最终收入流很小，而且在向客户提供最佳工具方面存在利益冲突，因此我们不再与合作伙伴分享收入。相反，我们只从客户那里获得收入。

![Zoom with margin](../Images/f6d9c36d72df6f2a15e079d18b4617ab.png "asset_O9YLKZm42rVhZsLn.png")
...
![Zoom with margin](../Images/5ca5e73787e5430730f4723dd046f3bf.png "asset_fTwPKiZUoDjmwnBA.png")
...
![Zoom with margin](../Images/ad77929fa0ca504efd63b93a348c088c.png "asset_x3q6BPfzO6ZpLEKs.png")

最后，我们分享了我们能找到的所有凭证。这是一个很短的名单，有四个人以前从未做过“真正的”工作……但是两年的经验足以让我们变得危险

![Zoom with margin](../Images/cb2147ec1b15c5326891702b71076de0.png "asset_Ovn3asAVfZTgmG81.png")
...
![Zoom with margin](../Images/9fb057cdfcbf22d904257dbbd79eeb3e.png "asset_pyhZv1QsNgGNNHCx.png")
