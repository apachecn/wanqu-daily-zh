...
> 原文:[https://AWS . Amazon . com/blogs/big-data/how-good reads-offloads-Amazon-dynamo db-tables-to-Amazon-S3-and-queries-them-using-Amazon-Athena/？UTM _ source = Wanqu . co&UTM _ campaign = Wanqu+Daily&UTM _ medium = website](https://aws.amazon.com/blogs/big-data/how-goodreads-offloads-amazon-dynamodb-tables-to-amazon-s3-and-queries-them-using-amazon-athena/?utm_source=wanqu.co&utm_campaign=Wanqu+Daily&utm_medium=website)
...
![](../Images/95b036d57f8f175afcf116a152c0de65.png)
...
1.  点击这个这个**启动堆栈**按钮:[![](../Images/b8a921e6f647a32c674b9387967cb6f5.png)](https://console.aws.amazon.com/cloudformation/home?region=us-east-1#/stacks/new?stackName=AWSBigData-DynamoToAthena-Reviews&templateURL=https://s3.amazonaws.com/aws-bigdata-blog/artifacts/goodreads-dynamodb/reviews.yaml)
2.  选择屏幕底部的**下一个**。
...
2.  从左侧导航窗格![](../Images/10b81922fe41db9ccfb64bcb34aef8bd.png)中选择**表格**

3.  选择**评论**表，然后选择**条目**

![](../Images/11d19a45040e0ab83f5d8bde21950437.png)

4.  选择**创建项目**，在**创建项目**框中，为**树**选择**文本**。

![](../Images/29e9626e06ecb7c57efc416f3578f459.png)
...
1.  点击此**启动堆栈**按钮:[![](../Images/b8a921e6f647a32c674b9387967cb6f5.png)](https://console.aws.amazon.com/cloudformation/home?region=us-east-1#/stacks/new?stackName=AWSBigData-DynamoToAthena-Common&templateURL=https://s3.amazonaws.com/aws-bigdata-blog/artifacts/goodreads-dynamodb/common.yaml)
2.  选择屏幕底部的**下一个**。
3.  在**选项**屏幕上，将一切设置为默认，并选择屏幕底部的**下一步**。
...
1.  点击此**启动堆栈**按钮:[![](../Images/b8a921e6f647a32c674b9387967cb6f5.png)](https://console.aws.amazon.com/cloudformation/home?region=us-east-1#/stacks/new?stackName=AWSBigData-DynamoToAthena-DynamoDBExports&templateURL=https://s3.amazonaws.com/aws-bigdata-blog/artifacts/goodreads-dynamodb/dynamodb-exports.yaml)
...
![](../Images/5f2d839c35092af854b8b12159c5ae4f.png)

3.  在管道经历从配置集群到运行作业的各个阶段时，对其进行监控。

![](../Images/ef767f8ff230c9607d9dfbc420e1d556.png)

4.  当状态为**已完成**时，数据在 S3。

![](../Images/3986c46c3f1f6224adfd891393a5da10.png)

![](../Images/e4babaaa4d0e7c0fd8efa91d093a858a.png)
...
![](../Images/25f4066024d91db77e0dd4066872cbb5.png)
...
![](../Images/1ad5694605fd9e9d16b455f411068e07.png)
...
![](../Images/7ab09855d9e1587bb87fa7b55a6b9c6b.png)

2.  选择**评论**。

![](../Images/7d8a7414fd44c2c1687803ae027d23e1.png)
...
![](../Images/fec84d4510c763877a95639c88833076.png)

4.  在**表格**下，可以看到`reviews`。
5.  选择`reviews`右边的省略号，选择**预览表**。

![](../Images/e77e17d4eeec7dc1d7b6b3d2ebe62210.png)
...
![](../Images/37865279b5984a57be5f93c1caec25cf.png)
